...
export const AdminEmailSenderPage = () => {
	...
	// "https://beautyblossom-backend-production.onrender.com/api/email/sendemail",
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			for (const email of toEmails) {
				...
				requests.push(
					axios.post(
						"https://beautyblossom-backend-production.onrender.com/api/email/sendemail", // або змініть на свій локальний сервер
						formData,
						{
							headers: {
		...
		const fetchData = async () => {
			try {
				const response = await axios.post(
					...
					"https://beautyblossom-backend-production.onrender.com/api/searchUser",
