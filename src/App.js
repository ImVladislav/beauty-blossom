...
const UserData = lazy(() => import("./pages/UserPage/UserData"));
const PaymentHistory = lazy(() => import("./pages/UserPage/PaymentHistory"));
...
const ChangePassword = lazy(() => import("./pages/UserPage/ChangePassword"));
const NotFoundPage = lazy(() => import("./pages/NotFoundPage/NotFoundPage"));
const NoProducts = lazy(() => import("./pages/NoProducts/NoProducts"));
const Feedback = lazy(() => import("./pages/UserPage/Feedback"));
